    ...
    return (
        <>
            <main>
                ...
                <div className='flex-display div__setting'><HeadlineCatagory section_name={"Health"} />
                    <label className='toggleSwitch'>
                        <input type='checkbox' data-category="health" onInput={inputHandler} defaultChecked={showHealth === "true"} />
                        <div className='toggleSwitch__base'>
                            <div className='toggleSwitch__toggle'></div>
                        </div>
                    </label>
                ...
                <div className='flex-display div__setting'>
                    <HeadlineCatagory section_name={"Sports"} />
                    <label className='toggleSwitch'>
                        <input type='checkbox' data-category="sports" onInput={inputHandler} defaultChecked={showSports === "true"} />
                        <div className='toggleSwitch__base'>
                            <div className='toggleSwitch__toggle'></div>
                        </div>
                    </label>
                ...
                <div className='flex-display div__setting'>
                    <HeadlineCatagory section_name={"Business"} />
                    <label className='toggleSwitch'>
                        <input type='checkbox' data-category="business" onInput={inputHandler} defaultChecked={showBusiness === "true"} />
                        <div className='toggleSwitch__base'>
                            <div className='toggleSwitch__toggle'></div>
                        </div>
                    </label>
                ...
                <div className='flex-display div__setting'>
                    <HeadlineCatagory section_name={"Travel"} />
                    <label className='toggleSwitch'>
                        <input type='checkbox' data-category="travel" onInput={inputHandler} defaultChecked={showTravel === "true"} />
                        <div className='toggleSwitch__base'>
                            <div className='toggleSwitch__toggle'></div>
                        </div>
                    </label>
